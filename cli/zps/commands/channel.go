...
func NewZpsChannelCommand() *ZpsChannelCommand {
	...
	cmd.Ui = cli.NewUi()
	cmd.Use = "channel [REPO_NAME] [CHANNEL]"
	cmd.Short = "Add a package to a channel within a ZPS repository"
	cmd.Long = "Add a package to a channel within a ZPS repository"
