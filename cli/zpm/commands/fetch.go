...
type ZpmFetchCommand struct {
	*cobra.Command
	*cli.Ui
}

func NewZpmFetchCommand() *ZpmFetchCommand {
	cmd := &ZpmFetchCommand{}
...
func (z *ZpmFetchCommand) setup(cmd *cobra.Command, args []string) error {
...
func (z *ZpmFetchCommand) run(cmd *cobra.Command, args []string) error {
