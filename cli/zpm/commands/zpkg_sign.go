...
type ZpmZpkgSignCommand struct {
	*cobra.Command
	*cli.Ui
}

func NewZpmZpkgSignCommand() *ZpmZpkgSignCommand {
	cmd := &ZpmZpkgSignCommand{}
...
func (z *ZpmZpkgSignCommand) setup(cmd *cobra.Command, args []string) error {
...
func (z *ZpmZpkgSignCommand) run(cmd *cobra.Command, args []string) error {
